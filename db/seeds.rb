...
puts "Creating Users"
  ...
  User.create!(email: 'olivier@dotreppe.be', password: '123456', password_confirmation: '123456', first_name: 'Olivier', last_name: "d'Otreppe", generic_message: "I would be so happy to get my stuff back. Please contact me!").avatar.attach(io: file, filename: 'cover.png', content_type: 'image/png')
  ...
  User.create!(email: 'Lex.Radj@gmail.com', password: '123456', password_confirmation: '123456', first_name: 'Lex', last_name: "Radj", generic_message: "I would be so happy to get my stuff back. Please contact me!").avatar.attach(io: file, filename: 'cover.png', content_type: 'image/png')

  file = URI.open("https://res.cloudinary.com/wagon/image/upload/c_fill,g_face,h_200,w_200/v1603807623/rkkm2rsclqznydbt7rxb.jpg")
  User.create!(email: 'thibault.a@hotmail.com', password: '123456', password_confirmation: '123456', first_name: 'Thibault', last_name: "Alexandre", generic_message: "I would be so happy to get my stuff back. Please contact me!").avatar.attach(io: file, filename: 'cover.png', content_type: 'image/png')
